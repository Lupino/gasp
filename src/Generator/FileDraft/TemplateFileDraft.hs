...
instance Writeable TemplateFileDraft where
    write absDstDirPath absDataDirPath draft = do
        ...
        case _tmplData draft of
            ...
            Just tmplData -> do
                content <- compileAndRenderTemplate absDataDirPath (_srcPathInTmplDir draft) tmplData
      ...
      where
        ...
        absDraftSrcPath = getTemplateFileAbsPath absDataDirPath (_srcPathInTmplDir draft)
